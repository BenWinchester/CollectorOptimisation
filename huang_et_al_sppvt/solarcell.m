...
if G~=0
    ...
    if strcmp(cell,'silicon')==1
        k1=0.03; %empirical parameter, Fan, J. C. (1986). Theoretical temperature dependence of solar cell parameters. Solar cells, 17(2-3), 309-315.
    ...
    SR=table2array(readtable('data', sheet='solar cells', range='I3:I2004')); % Si, SunPowe C60 Solar Cell,cell efficiency 25.1%
    ...
    SR=table2array(readtable('data', sheet='solar cells', range='D3:D2004')); % CdTe, First Solar 4 sereries,cell efficiency 22.1%
    ...
    Jsc=0;
    lamadaG=table2array(readtable('data', sheet='ambient conditions', range='B2:B2004'));
