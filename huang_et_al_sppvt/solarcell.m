...
if G~=0
    ...
    SR=readtable('data', sheet='solar cells', range='I3:I2004'); % Si, SunPowe C60 Solar Cell,cell efficiency 25.1%
    ...
    SR=readtable('data', sheet='solar cells', range='D3:D2004'); % CdTe, First Solar 4 sereries,cell efficiency 22.1%
