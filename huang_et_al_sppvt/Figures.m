...
x_G=table2array(readtable('data.xlsx', sheet='ambient conditions', range='B2:B2003'));
SR_CdTe=table2array(readtable('data.xlsx', sheet='solar cells', range='D3:D2004'));
SR_Sil=table2array(readtable('data.xlsx', sheet='solar cells', range='I3:I2004'));
